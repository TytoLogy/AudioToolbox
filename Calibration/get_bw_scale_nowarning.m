function vrms_out = get_bw_scale_nowarning(dbspl, caldata, bw)
%vrms_out = get_bw_scale_nowarning(dbspl, caldata, bw)
% 
% given desired stimulus level in dB, returns Voltage rms scale
% value to achieve output level
%
% same as get_bw_scale, but without warning messages
% 
% Input Arguments:
